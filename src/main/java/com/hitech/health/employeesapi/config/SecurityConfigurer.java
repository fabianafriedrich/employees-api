package com.hitech.health.employeesapi.config;

import com.hitech.health.employeesapi.jwt.JWTAuthorizationFilter;
...
public class SecurityConfigurer extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.cors().and()
                ...
                .logout().permitAll()
                .logoutRequestMatcher(new AntPathRequestMatcher("/employee/logout", "POST"))
                .and()
                //login form and path
                .formLogin().loginPage("/employee/login").and()
